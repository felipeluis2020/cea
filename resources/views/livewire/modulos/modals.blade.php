        ...
        <div class="modal-content shadow-lg rounded-4 border-0">
            <div class="modal-header bg-light rounded-top-4 border-bottom-0 pb-0">
                <h5 class="modal-title fw-bold text-primary" id="DataModalLabel">
                    <i class="bi-box-seam-fill me-2"></i> {{ $selected_id ? 'Update Modulo' : 'Create Modulo' }}
                </h5>
            ...
            <div class="modal-body p-4">
                <form>
                    ...
                    <div class="form-floating mb-3">
                        <input wire:model.live="nombre_modulo" type="text" class="form-control @error('nombre_modulo') is-invalid @enderror" id="nombre_modulo" placeholder="Nombre Modulo">
                        <label for="nombre_modulo">Nombre Modulo</label>
                        @error('nombre_modulo') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
