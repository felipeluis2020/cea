        ...
        <div class="modal-content shadow-lg rounded-4 border-0">
            <div class="modal-header bg-light rounded-top-4 border-bottom-0 pb-0">
                <h5 class="modal-title fw-bold text-primary" id="DataModalLabel">
                    <i class="bi-tools me-2"></i> {{ $selected_id ? 'Update Estadomantenimiento' : 'Create Estadomantenimiento' }}
                </h5>
            ...
            <div class="modal-body p-4">
                <form>
                    ...
                    <div class="form-floating mb-3">
                        <input wire:model.live="nombre_estado_mantenimiento" type="text" class="form-control @error('nombre_estado_mantenimiento') is-invalid @enderror" id="nombre_estado_mantenimiento" placeholder="Nombre Estado Mantenimiento">
                        <label for="nombre_estado_mantenimiento">Nombre Estado Mantenimiento</label>
                        @error('nombre_estado_mantenimiento') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
