            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="tenant_id" class="col-md-4 col-form-label text-md-end">{{ __('Empresa') }}</label>

                            <div class="col-md-6">
                                <select id="tenant_id" class="form-control @error('tenant_id') is-invalid @enderror" name="tenant_id" required>
                        ...
                        <div class="row mb-3">
                            <label for="document_type_id" class="col-md-4 col-form-label text-md-end">{{ __('Tipo de Documento') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="document_number" class="col-md-4 col-form-label text-md-end">{{ __('Número de Documento') }}</label>
